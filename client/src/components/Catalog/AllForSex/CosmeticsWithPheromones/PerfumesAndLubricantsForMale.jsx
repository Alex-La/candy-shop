...
const PerfumesAndLubricantsForMale = () => {
  ...
  const { data, loading, fetchMore, refetch } = useQuery(PRODUCTS_QUERY, {
    ...
    variables: {
      filter,
      subsection: "Духи и смазки для мужчин",
      orderBy,
        ...
        <div className="row">
          <div className="col s12">
            <ul className="breadcrumb">
              ...
              <li className="black-text">Духи и смазки для мужчин</li>
            </ul>
          </div>
        </div>
      </div>
...
export default PerfumesAndLubricantsForMale;
