...
const BreastPumpsAndStimulants = () => {
  ...
  const { data, loading, fetchMore, refetch } = useQuery(PRODUCTS_QUERY, {
    ...
    variables: {
      subsection: "Помпы и стимуляторы для груди",
      orderBy,
        ...
        <div className="row">
          <div className="col s12">
            <ul className="breadcrumb">
              ...
              <li className="black-text">Помпы и стимуляторы для груди</li>
            </ul>
          </div>
        </div>
      </div>
...
export default BreastPumpsAndStimulants;
