...
const VibrationStimulantsAndVibrationBullets = () => {
  ...
  const { data, loading, fetchMore, refetch } = useQuery(PRODUCTS_QUERY, {
    ...
    variables: {
      subsection: "Вибростимуляторы, вибропульки ",
      orderBy,
        ...
        <div className="row">
          <div className="col s12">
            <ul className="breadcrumb">
              ...
              <li className="black-text">Вибростимуляторы, вибропульки</li>
            </ul>
          </div>
        </div>
      </div>
...
export default VibrationStimulantsAndVibrationBullets;
