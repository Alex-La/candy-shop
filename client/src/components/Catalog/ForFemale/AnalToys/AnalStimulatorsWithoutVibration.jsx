...
const AnalStimulatorsWithoutVibration = () => {
  ...
  const { data, loading, fetchMore, refetch } = useQuery(PRODUCTS_QUERY, {
    ...
    variables: {
      subsection: "Анальные стимуляторы без вибрации",
      orderBy,
        ...
        <div className="row">
          <div className="col s12">
            <ul className="breadcrumb">
              ...
              <li className="black-text">Анальные стимуляторы без вибрации</li>
            </ul>
          </div>
        </div>
      </div>
...
export default AnalStimulatorsWithoutVibration;
