        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col s12 m6" style={{ fontSize: 20 }}>
              ...
              <p>100% АНОНИМНОСТЬ ПОКУПКИ</p>
              <i className="grey-text">
                Купив любой товар в нашем магазине, Вы можете быть уверены в
                том, что никто из работников службы доставки или работников
                почты не узнает, какой товар находится в упаковке. Все секс
                игрушки упаковываются в непрозрачную упаковку без каких-либо
                пометок или логотипов производителя или магазина. Мы гарантируем
                Вам анонимность покупки.
              </i>
